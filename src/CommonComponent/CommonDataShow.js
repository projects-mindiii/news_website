    ...
    <div className="classiFieds_forSaleBox">
              ...
              <button
                ...
                style={{
                  background: `linear-gradient(to right, ${
                    props.yourdata.color_code &&
                    props.yourdata.color_code.start_color
                  }, ${
                    props.yourdata.color_code &&
                    props.yourdata.color_code.end_color
                  })`,
                  color: `text-color(to text color, ${
                    props.yourdata.color_code &&
                    props.yourdata.color_code.text_color
                  })`,
                }}
              >
                {props.yourdata.category_name
                  ? props.yourdata.category_name
                  : ""}
              </button>
      ...
      <div className="classiFieds_countryName ">
        <span>
          ...
          <span>
            {" "}
            {props.yourdata.country_name},{props.yourdata.province_name},
            {props.yourdata.city}
          </span>
        </span>
      </div>
