...
function ClassifiedCategoryList({ forSaleListData,displayRoute }) {
  ...
  return (
    <div className="main">
      {forSaleListData &&
        ...
        {displayRoute &&  displayRoute=="your_advert" && forSaleListData && forSaleListData.some(item => item.approval_status == 0) == true && <h5 className="youAdd_PendingApproval">---- PENDING APPROVAL ----</h5>}
         {forSaleListData &&
        forSaleListData.length > 0 &&
        forSaleListData.map((item, index) => {
          return (
