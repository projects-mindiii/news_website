...
function PostAdvert() {
  ...
  const [employmentEquity, setEmploymentEquity] = useState([
    { id: 1, name: "none" },
    { id: 2, name: "EE/ AA Required" },
  ]);
  ...
  function negotiableWork() {
    document.getElementById("negotiables").checked == true
      ? setNegotiables(1)
      : setNegotiables(0);
  }
  const customStyles = {
  ...
  async function onSubmit(data) {
    ...
    requestData.append("is_default_country", countryvalue.id == 204 ? 1 : 0);
    requestData.append("country_id", countryvalue.value);
    requestData.append("classified_type", userCategory);
    requestData.append("emp_equity", employment);
    requestData.append("province", provincesvalue.id);
    requestData.append("city", data.city);
    requestData.append("currency_id", currencyvalue.id);
    requestData.append("is_negotiable", negotiables);
    requestData.append("job_location_type", countryvalue.id);
    requestData.append("price", data.amount);

    requestData.append("earning_options", earningValue.value);
    requestData.append("job_type", jobValue.value ? jobValue.value : "");
    requestData.append("contact_name", data.fullName);
    requestData.append("email", data.email);
    requestData.append("contact_compan", data.companyName);
    requestData.append("dial_code", dialCode);
    requestData.append("country_code", countryCode);
    requestData.append("contact_number", phoneNo);
    ...
    await SublyApi.addClassifiedList(requestData, userToken).then(
      (responsejson) => {
                ...
                <div className="post_Add_CategoryButton">
                  ...
                  >
                      ...
                      <div className="mt-3">
                        ...
                        <Form.Group>
                          <Form.Control
                            ...
                            className="post_Add_Discription"
                    ...
                    {trigger == true && userCategory == 6 && !jobValue && (
                      <div className="post_Add_Error">Select job Type</div>
                    )}
                    ...
                    {(userCategory == 7 || userCategory == 6) &&
                      !selectLocation && (
                        <div className="post_Add_Error">Select Option</div>
                      )}
                    {userCategory == 6 && (
                      <div>
                        ...
                        <div className="post_Add_EmploymentEnquiry  selectNew">
                          {employmentEquity
                            ? employmentEquity.map((type, index) => (
                                <div key={index}>
                                  <Form.Check
                                    className="post_Add_category"
                    ...
                    {userCategory == 4 ? (
                      <div className="headings mb-3">PRICE</div>
                    ) : (
                      <div className="headings mb-3">RENUMERATION</div>
                    )}
